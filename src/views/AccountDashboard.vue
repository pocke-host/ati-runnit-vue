...
.status-dot{width:8px;height:8px;border-radius:50%;background:#000;flex-shrink:0}
...
.perf-change--up{color:#fff;background:#000;padding:1px 6px;display:inline-block}
