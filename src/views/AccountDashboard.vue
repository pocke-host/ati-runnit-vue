...
.status-dot{width:8px;height:8px;border-radius:50%;background:var(--rk-signal,#C8872A);flex-shrink:0}
...
.perf-change--up{color:var(--rk-void,#14102A);background:var(--rk-signal,#C8872A);padding:1px 6px;display:inline-block}
...
.upgrade-btn{display:inline-block;background:var(--rk-signal,#C8872A);color:var(--rk-void,#14102A);font-weight:700;font-size:0.75rem;letter-spacing:0.10em;text-transform:uppercase;text-decoration:none;padding:10px 20px;border-radius:0;transition:background 0.15s}
...
.goal-fill{height:100%;background:var(--rk-signal,#C8872A);border-radius:0;transition:width 0.3s}
