...
const query = ref(''); const results = ref([]); const recommendations = ref({}); const loading = ref(true); const recommendationError = ref(false); const spotifySummary = ref(null); const summaryPeriod = ref('week')
