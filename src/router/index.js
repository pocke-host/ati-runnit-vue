...
const routes = [
  ...
  { path: '/coros-coach',         name: 'CorosCoach',     component: () => import('@/views/CorosCoach.vue'), meta: { requiresAuth: true } },
  { path: '/join-coach/:code',    name: 'JoinCoach',      component: () => import('@/views/JoinCoach.vue') },
  { path: '/join/:code',          name: 'JoinFriend',     component: () => import('@/views/JoinFriend.vue') },
  { path: '/friends',             name: 'FindFriends',    component: () => import('@/views/FindFriends.vue'), meta: { requiresAuth: true } },
  ...
  { path: '/train',               name: 'TrainingHub', component: () => import('@/views/TrainingHub.vue'), meta: { requiresAuth: true } },
  ...
  { path: '/discover',            name: 'Discover',       component: () => import('@/views/Discovery.vue'),        meta: { requiresAuth: true } },
  ...
  { path: '/calendar/sync',       name: 'GoogleCalendarSync', component: () => import('@/views/GoogleCalendarIntegration.vue'), meta: { requiresAuth: true } },
  ...
  { path: '/coach/library',            name: 'WorkoutLibrary',      component: () => import('@/views/WorkoutLibrary.vue'),      meta: { requiresAuth: true, requiresCoach: true } },
